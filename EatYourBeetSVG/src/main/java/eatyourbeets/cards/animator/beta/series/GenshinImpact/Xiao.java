...
public class Xiao extends AnimatorCard implements Hidden
{
    public static final EYBCardData DATA = Register(Xiao.class).SetAttack(1, CardRarity.COMMON, EYBAttackType.Ranged).SetSeriesFromClassPackage();
