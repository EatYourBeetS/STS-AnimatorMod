...
public class SFX
{
    public static void Initialize()
    {
        ...
        BaseMod.addAudio(ANIMATOR_SUPPORT_DAMAGE, "audio/animator/sound/EVFX02_11_QuickBlade.ogg");
    ...
    public static final String ANIMATOR_SUPPORT_DAMAGE = "ANIMATOR_SUPPORT_DAMAGE";
