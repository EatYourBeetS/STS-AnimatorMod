...
import pinacolada.actions.orbs.AirOrbEvokeAction;
import pinacolada.actions.orbs.AirOrbPassiveAction;
...
public class Air extends PCLOrb
{
    ...
    public void updateAnimation()
    {
        ...
        if (this.vfxTimer < 0.0F) {
            PCLGameEffects.List.Add(new FadingParticleEffect(IMAGES.AirCloud.Texture(), hb.cX, hb.cY)
    ...
    public void Evoke()
    {
        ...
        PCLActions.Top.Add(new AirOrbEvokeAction(GetEvokeDamage(), this.evokeAmount));
    ...
    public void Passive()
    {
        ...
        PCLActions.Bottom.Add(new AirOrbPassiveAction(this, this.passiveAmount));
    }
