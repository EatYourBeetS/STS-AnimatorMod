...
public class SupportDamageEffect extends EYBEffect
{
    ...
    protected void UpdateInternal(float deltaTime)
    {
        ...
        if (vfxTimer < 0f)
        {
            ...
            GameEffects.Queue.Add(new ThrowProjectileEffect(projectile, targetHb)
                    .AddCallback(hb -> GameEffects.Queue.Add(VFX.Gunshot(targetHb, 0f).SetBlendingMode(RenderHelpers.BlendingMode.Glowing).SetColor(Colors.Lerp(Color.SCARLET, Color.GOLD, MathUtils.random(0f,1f))))
