...
{
    public static final PCLCardData DATA = Register(Traveler_Wish.class).SetSkill(0, CardRarity.SPECIAL, eatyourbeets.cards.base.EYBCardTarget.None).SetColor(CardColor.COLORLESS);
