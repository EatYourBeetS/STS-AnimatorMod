...
public class Senku extends AnimatorCard
{
    ...
    {
        AbstractGameAction.AttackEffect attackEffect = this.transformed || this.attackType.equals(EYBAttackType.Elemental) ? AttackEffects.PSYCHOKINESIS : AttackEffects.BLUNT_LIGHT;
