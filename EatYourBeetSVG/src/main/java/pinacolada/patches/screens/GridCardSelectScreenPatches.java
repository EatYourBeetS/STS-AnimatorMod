...
public class GridCardSelectScreenPatches
{
    ...
    public static class BranchUpgradeConfirm {
        ...
        public static SpireReturn Prefix(GridSelectConfirmButton __instance, SpriteBatch sb) {
            AbstractCard c = GridCardSelectScreenPatches.getHoveredCard();
            return (Boolean)GridCardSelectScreenPatches.BranchSelectFields.waitingForBranchUpgradeSelection.get(AbstractDungeon.gridSelectScreen) && c instanceof PCLCard && ((PCLCard) c).cardData.CanToggleOnUpgrade ? SpireReturn.Return((Object)null) : SpireReturn.Continue();
        }
    }
