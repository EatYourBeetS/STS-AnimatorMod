    ...
    protected void FirstUpdate()
    {
        ...
        for (Affinity affinity : affinities) {
            ...
            if (System.GetAffinityLevel(affinity,true) >= req) {
                ...
                AnimatorCardBuilder builder = new AnimatorCardBuilder(token, affinityCost.GetText(), false).SetOnUse(affinityCost::Use).SetID(token.cardID).SetNumbers(0,0,req,0, 1);
