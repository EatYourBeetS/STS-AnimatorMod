...
public class GridCardSelectScreenPatch
{
    ...
    private static final FieldInfo<Float> _padY = PCLJUtils.GetField("padY", GridCardSelectScreen.class);
    private static final FieldInfo<Float> _drawStartY = PCLJUtils.GetField("drawStartY", GridCardSelectScreen.class);
    private static final FieldInfo<Float> _currentDiffY = PCLJUtils.GetField("currentDiffY", GridCardSelectScreen.class);
    private static final FieldInfo<AbstractCard> _hoveredCard = PCLJUtils.GetField("hoveredCard", GridCardSelectScreen.class);
    private static final FieldInfo<CardGroup> _targetGroup = PCLJUtils.GetField("targetGroup", GridCardSelectScreen.class);
    private static final FieldInfo<Integer> _prevDeckSize = PCLJUtils.GetField("prevDeckSize", GridCardSelectScreen.class);
    private static final FieldInfo<Float> _scrollUpperBound = PCLJUtils.GetField("scrollUpperBound", GridCardSelectScreen.class);
