...
public class Yoimiya extends AnimatorCard implements Hidden
{
    public static final EYBCardData DATA = Register(Yoimiya.class).SetAttack(2, CardRarity.SPECIAL, EYBAttackType.Ranged).SetSeries(CardSeries.GenshinImpact);
