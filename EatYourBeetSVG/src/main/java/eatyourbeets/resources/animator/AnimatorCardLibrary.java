...
public class AnimatorCardLibrary extends AbstractCardLibrary
{
    @Override
    ...
    public EYBCardData GetCardData(String cardID)
    {
        ...
        {
            final EYBCardData data = EYBCard.GetStaticData(GR.AnimatorClassic.ConvertID(cardID, false));
            if (data == null)
            {
                if (cardID.equals(ImprovedStrike.DATA.SharedID))
                {
                    return Strike_Star.DATA;
                }
                if (cardID.equals(ImprovedDefend.DATA.SharedID))
                {
                    return Defend_Star.DATA;
                }
            }
