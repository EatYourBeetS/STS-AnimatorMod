        ...
        if (this.hb.hovered)
        {
            if (tooltip == null)
            {
                ...
                if (statistics != null)
                {
                    ...
                    {
                        builder.append(JUtils.Format(" NL [A_{0}] : {1} ( #b{2} )", g.Affinity.Name, g.GetPercentageString(0), g.GetTotal(0)));
                    }
            ...
            EYBCardTooltip.QueueTooltip(tooltip, 360 * Settings.scale, InputHelper.mY + 120 * Settings.scale, false);
