...
public class PowerHelper
{
    ...
    public static final PowerHelper Intangible = new PowerHelper(IntangiblePlayerPower.POWER_ID, GR.Tooltips.Intangible, IntangiblePlayerPower::new, Behavior.TurnBased,false);
    ...
    public static final PowerHelper Regen = new PowerHelper(RegenPower.POWER_ID, GR.Tooltips.Regeneration, RegenPower::new, Behavior.TurnBased,false);
