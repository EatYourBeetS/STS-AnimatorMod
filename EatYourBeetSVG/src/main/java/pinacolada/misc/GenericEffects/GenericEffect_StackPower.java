...
public class GenericEffect_StackPower extends GenericEffect
{
    ...
    public GenericEffect_StackPower(PowerHelper power, PCLCardTooltip tooltip, int amount)
    {
        this(power,tooltip,amount,false);
    }

    public GenericEffect_StackPower(PowerHelper power, PCLCardTooltip tooltip, int amount, boolean temporary)
    {
        this.power = power;
