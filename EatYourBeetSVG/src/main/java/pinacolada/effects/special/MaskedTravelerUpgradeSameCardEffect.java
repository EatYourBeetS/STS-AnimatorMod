...
public class MaskedTravelerUpgradeSameCardEffect extends AbstractGameEffect
{
    ...
    public void update()
    {
        ...
        else if (AbstractDungeon.gridSelectScreen.selectedCards.size() > 0)
        {
            ...
            PCLGameEffects.Queue.Add(new UpgradeShineEffect((float)Settings.WIDTH / 2f, (float)Settings.HEIGHT / 2f));
            ...
            PCLGameEffects.Queue.ShowCardBriefly(c.makeStatEquivalentCopy());
            PCLGameUtilities.GetCurrentRoom(true).phase = AbstractRoom.RoomPhase.COMPLETE;
