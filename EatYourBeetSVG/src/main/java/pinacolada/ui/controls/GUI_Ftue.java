...
public class GUI_Ftue extends FtueTip //TODO
{
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(GR.PCL.Images.Panel_Rounded.Texture(), this.x - 311.0F, this.y - 142.0F, 311.0F, 142.0F, 622.0F, 334.0F, Settings.scale * 2.5f, Settings.scale * 2.5f, 0.0F, 0, 0, 700, 300, false, false);
