...
public class PotionBounceEffect2 extends AbstractGameEffect
{
    ...
    public PotionBounceEffect2(float srcX, float srcY, float destX, float destY)
    {
        if (img == null)
        {
    ...
    public PotionBounceEffect2 SetColor(Color color)
    {
