...
{
    public static final EYBCardData DATA = Register(RundelhausCode.class).SetAttack(1, CardRarity.COMMON, EYBAttackType.Elemental);
    ...
    public void use(AbstractPlayer p, AbstractMonster m)
    {
        ...
        if (IsStarter())
        {
            ...
            {
                if (c.type.equals(CardType.ATTACK) && c.baseDamage > 0 && c instanceof EYBCard && ((EYBCard) c).cardData.AttackType.equals(EYBAttackType.Elemental))
                {
