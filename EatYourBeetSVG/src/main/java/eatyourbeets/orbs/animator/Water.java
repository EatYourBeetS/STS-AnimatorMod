...
public class Water extends AnimatorOrb
{
    ...
    public Water()
    {
        ...
        if (imgExt == null)
        {
            imgExt = ImageMaster.loadImage("images/orbs/animator/WaterExternal.png");
            imtInt = ImageMaster.loadImage("images/orbs/animator/WaterInternal.png");
        }
    ...
    {
        return super.GetOrbFlareEffect().SetColors(Color.SKY, Color.TEAL);
    }

    public Water SetBasePassivePower(int amount)
    {
