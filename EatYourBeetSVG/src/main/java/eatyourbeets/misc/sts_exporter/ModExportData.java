...
public class ModExportData
{
    ...
    public ModExportData(ExportHelper export, ModInfo info)
    {
        this.info = info;
        this.id = info.ID;
        this.name = info.Name;
    ...
    public ModExportData(ExportHelper export)
    {
        this.info = null;
    ...
    public void exportImages()
    {
        ...
        for (RelicExportData x : this.relics)
        {
            x.exportImages();
        }
        for (CreatureExportData x : this.creatures)
        {
            x.exportImages();
        }
        for (PotionExportData x : this.potions)
        {
            x.exportImages();
        }
    }
