...
public class ToushirouHitsugaya_Bankai extends AnimatorCard  //TODO
{
    public static final EYBCardData DATA = Register(ToushirouHitsugaya_Bankai.class).SetAttack(1, CardRarity.SPECIAL, EYBAttackType.Normal).SetMaxCopies(2).SetSeriesFromClassPackage();
