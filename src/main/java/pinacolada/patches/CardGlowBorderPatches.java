...
{
    protected static final FieldInfo<AbstractCard> _card = PCLJUtils.GetField("card", CardGlowBorder.class);
    protected static final FieldInfo<TextureAtlas.AtlasRegion> _img = PCLJUtils.GetField("img", CardGlowBorder.class);
    protected static final FieldInfo<Float> _scale = PCLJUtils.GetField("scale", CardGlowBorder.class);
    protected static final FieldInfo<Color> _color = PCLJUtils.GetField("color", AbstractGameEffect.class);
