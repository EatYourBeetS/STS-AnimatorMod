...
public class EYBSingleCardPopup extends GUIElement
{
    ...
    private final Texture buttonTexture = GR.PCL.Images.HexagonalButton.Texture();
    private final Texture buttonBorderTexture = GR.PCL.Images.HexagonalButtonBorder.Texture();
