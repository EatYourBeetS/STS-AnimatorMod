...
public class EYBCardCooldown
{
    ...
    public EYBCardCooldown(EYBCard card, int baseCooldown, int cooldownUpgrade, FuncT0<EYBCard> cardConstructor, boolean canProgressOnManualDiscard, boolean canProgressFromExhaustPile, boolean canProgressOnDraw, boolean shouldReplaceCard)
    {
        card.baseCooldownValue = card.cooldownValue = baseCooldown;
        card.upgrade_cooldownValue = cooldownUpgrade;
