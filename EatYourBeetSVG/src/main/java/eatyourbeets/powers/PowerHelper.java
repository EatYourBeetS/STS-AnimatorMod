...
public class PowerHelper
{
    ...
    public static final PowerHelper Electrified = new PowerHelper(ElectrifiedPower.POWER_ID, GR.Tooltips.Freezing, ElectrifiedPower::new);
    ...
    public static final PowerHelper Genesis = new PowerHelper(GenesisPower.POWER_ID, null, GenesisPower::new);
