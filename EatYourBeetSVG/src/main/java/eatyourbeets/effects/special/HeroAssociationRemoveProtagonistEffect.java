...
public class HeroAssociationRemoveProtagonistEffect extends EYBEffectWithCallback<Object>
{
    ...
    public HeroAssociationRemoveProtagonistEffect(int remove, int obtain)
    {
        super(0.75f, true);
