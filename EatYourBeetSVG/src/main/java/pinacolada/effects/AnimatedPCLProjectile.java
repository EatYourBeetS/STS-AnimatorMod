...
public class AnimatedPCLProjectile extends PCLProjectile
{
    ...
    public AnimatedPCLProjectile(Texture texture, int rows, int columns)
    {
        this(texture, rows, columns, 0.03F);
    }

    public AnimatedPCLProjectile(Texture texture, int rows, int columns, float frameDuration)
    {
        this(texture, rows, columns, frameDuration, rows * columns);
    }

    public AnimatedPCLProjectile(Texture texture, int rows, int columns, float frameDuration, int maxFrames)
    {
    ...
    public void Render(SpriteBatch sb, Color color, float cX, float cY, float scale)
    {
        ...
        PCLRenderHelpers.DrawCentered(sb, color, region, cX, cY, width, height, scale, GetRotation(true), flipX, flipY);
    }
