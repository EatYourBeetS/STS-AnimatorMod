...
public class GenericEffect_GainAffinity extends GenericEffect
{
    ...
    public GenericEffect_GainAffinity(Affinity affinity, int amount)
    {
    ...
    {
        return GR.Animator.Strings.Actions.GainAmount("+" + amount, affinity.GetTooltip(), true);
    }

    @Override
    public void Use(AnimatorCard card, AbstractPlayer p, AbstractMonster m)
    {
        GameUtilities.AddAffinity(affinity,amount,true);
    }
}
