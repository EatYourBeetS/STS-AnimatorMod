...
public class AyatoNaoi extends AnimatorCard_OnSpecialPlay
{
    public static final EYBCardData DATA = AnimatorCard.Register(AyatoNaoi.class).SetSkill(3, CardRarity.RARE, EYBCardTarget.None);
