...
public class AinzPower extends AnimatorClassicPower
{
    ...
    private final static WeightedList<AnimatorClassicCardBuilder> effectList = new WeightedList<>();
...
//        }
//
//        public AnimatorClassicCardBuilder Generate(ActionT3<AnimatorClassicCard, AbstractPlayer, AbstractMonster> onUseAction)
//        {
//            AnimatorClassicCardBuilder builder = new AnimatorClassicCardBuilder(Ainz.DATA.ID + "Alt");
//
...
//        protected static AnimatorClassicCardBuilder GenerateEffect(AinzEffect effect)
//        {
//            switch (effect)
//            {
//                case PlayTopCard:
