...
public class MaskedTravelerTransformCardsEffect extends EYBEffectWithCallback<Object>
{
    ...
    public void OpenPanel_Add()
    {
        ...
        if (cards.Size() == 0)
        {
            ...
            {
                PCLJUtils.LogWarning(this, "Not enough uncommon cards in the card pool");
                Complete(this);
                return;
            }
        }
        ...
        AbstractDungeon.getCurrRoom().phase = AbstractRoom.RoomPhase.INCOMPLETE;
        AbstractDungeon.gridSelectScreen.open(cardGroup, cardsToRemove, GR.PCL.Strings.GridSelection.ChooseOneCard, false, false, false, false);
        openedPanel = true;
    }
}
