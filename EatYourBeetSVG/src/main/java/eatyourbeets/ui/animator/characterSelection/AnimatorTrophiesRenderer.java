...
//        trophy3Hb.move(baseX + 500f * Settings.scale, baseY + 94f * Settings.scale);
    ...
    public void Update()
    {
        ...
        {
            EYBCardTooltip.QueueTooltip(tooltip.SetText(trophyStrings.Bronze, loadout.GetTrophyMessage(1)));
        }
        else if (trophy2_image.hb.hovered)
        {
            EYBCardTooltip.QueueTooltip(tooltip.SetText(trophyStrings.Silver, loadout.GetTrophyMessage(2)));
        }
        else if (trophy3_image.hb.hovered)
        {
            EYBCardTooltip.QueueTooltip(tooltip.SetText(trophyStrings.Gold, loadout.GetTrophyMessage(3)));
        }
    }
