...
import eatyourbeets.actions.basic.CycleCards;
...
import eatyourbeets.actions.powers.StealStrength;
...
public final class GameActionsHelper2 extends GameActionsHelperBase
{
    ...
    public static StealStrength StealStrength(AbstractCreature target, int amount, boolean temporary)
    {
        return AddToDefault(new StealStrength(AbstractDungeon.player, target, amount, temporary));
    }
