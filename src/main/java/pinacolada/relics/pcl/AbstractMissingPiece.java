...
public abstract class AbstractMissingPiece extends PCLRelic implements OnReceiveRewardsListener
{
    ...
    {
        AbstractMissingPiece missingPiece = PCLGameUtilities.GetRelic(AbstractMissingPiece.class);
    ...
    private WeightedList<CardSeries> CreateWeightedList()
    {
        ...
        final RandomizedList<CardSeries> seriesList = new RandomizedList<>(PCLJUtils.Map(GR.PCL.Dungeon.Loadouts, series -> series.Loadout.Series));
