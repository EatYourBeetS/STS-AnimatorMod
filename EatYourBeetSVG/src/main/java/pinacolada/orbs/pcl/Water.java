...
import pinacolada.actions.orbs.WaterOrbPassiveAction;
...
public class Water extends PCLOrb
{
    ...
    public void updateAnimation()
    {
        ...
        if (this.vfxTimer < 0.0F) {
            PCLGameEffects.Queue.Add(new FadingParticleEffect(IMAGES.WaterBubble.Texture(), hb.cX, hb.cY)
    ...
    {
        SFX.Play(SFX.PCL_ORB_WATER_CHANNEL, 0.9f, 1.1f);
    }
    ...
    public void Evoke()
    {
        PCLActions.Top.Add(new WaterOrbEvokeAction(this.hb, evokeAmount));
        super.Evoke();
        turns = 0;
        PCLCombatStats.onStartOfTurnPostDraw.Unsubscribe(this);
        evoked = true;
        ...
        {
            PCLActions.Bottom.Heal(HP_HEAL);
        }
    }
    ...
    public void Passive()
    {
        PCLActions.Bottom.Add(new WaterOrbPassiveAction(this, passiveAmount));
