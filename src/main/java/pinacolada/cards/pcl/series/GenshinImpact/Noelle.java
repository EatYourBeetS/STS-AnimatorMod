...
{
    public static final PCLCardData DATA = Register(Noelle.class).SetSkill(1, CardRarity.COMMON, eatyourbeets.cards.base.EYBCardTarget.Self).SetSeriesFromClassPackage();
