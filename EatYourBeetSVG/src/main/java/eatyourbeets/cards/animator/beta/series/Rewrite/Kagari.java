    ...
    public static class KagariPower extends AnimatorPower implements OnChannelOrbSubscriber
    {
        ...
        public void OnChannelOrb(AbstractOrb orb) {
            if (Earth.ORB_ID.equals(orb.ID) && amount > 0) {
                GameActions.Bottom.RaiseEarthLevel(willpowerAmount + (player.stance.ID.equals(WillpowerStance.STANCE_ID) ? 1 : 0), player.stance.ID.equals(WillpowerStance.STANCE_ID));
