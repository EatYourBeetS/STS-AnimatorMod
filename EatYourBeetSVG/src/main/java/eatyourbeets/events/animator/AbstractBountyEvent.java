...
public abstract class AbstractBountyEvent extends EYBEvent
{
    ...
    private static class Introduction extends EYBEventPhase<AbstractBountyEvent, AbstractBountyEvent.EventStrings>
    {
        @Override
